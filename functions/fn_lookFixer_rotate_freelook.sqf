...
_xValue = [(PCT_lookFix_xPos * _coef) / _zoom, -1, 1] call BIS_fnc_clamp; 

_horVec = [vectorDir player, _xValue, 2] call BIS_fnc_rotateVector3D;  

player setVectorDir _horVec; 

//TODO: remove the need for this code - it should be possible to make this work in the same way as horizontal movement.
